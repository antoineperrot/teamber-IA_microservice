...
class Planning(object):
    # Création de l'objet
    def __init__(self, plages_horaire_json_file : str,
    			tasks_json_file : str,
    ...
    def _initialise_sprint(self):
        ...
        self.base = calcul_base_planning(self.plages_horaires,
    ...
    def _load_imperatifs(self):
        ...
        self.base = add_imperatifs(self.base, df, self.DATE_DEBUT, self.longueur_min_plage) # enlève les moments de disponibilités correspondants aux impératifs
    ...
    def show_scores(self):
        if self.has_tasks :
            print('Pourcentage temps perdu : {:.2f}%'.format(self.score_temps_perdu*100))
    ...
    def optimize(self, ITERATIONS_PAR_TACHE = 150,TEMPERATURE_INITIALE = 1,TEMPERATURE_MIN = 1e-5,show=False):
    ...
    def not_scheduled(self):
        ...
        if len(not_scheduled) > 0 :
            ...
            notScheduledTasks = pd.DataFrame(notScheduledTasks.groupby(['id tache','Objet','Priorité'],as_index=False)['Durée'].sum())
