...
class TestAvanceCurseurTemps(unittest.TestCase):
    ...
    def test(self):
        for ph, curseur_temps, date_fin_sprint, expected_result in zip(self.phs, self.curseurs_temps,
                                                                       self.dates_fins_sprint, self.expected_results):
...
class TestMakeDfPh(unittest.TestLoader):
    def setUp(self):
        ...
        self.df_horaires.append(pd.DataFrame({'eeh_sfkperiode': {0: 0, 1: 0, 2: 1, 3: 1, 4: 2, 5: 2, 6: 3, 7: 3, 8: 4},
                                              'eeh_xheuredebut': {0: '06:30',
                                                                  1: '11:30',
                                                                  2: '06:30',
                                                                  3: '11:30',
                                              ...
                                              'eeh_xheurefin': {0: '10:30',
                                                                ...
                                                                7: '15:30',
                                                                8: '10:00'}}))
        self.expected_results.append(pd.DataFrame({'timestamp_debut':
                                                   ...
                                                   'timestamp_fin': {0: Timestamp('2022-10-03 10:30:00+0000', tz='UTC'),
                                                                     ...
                                                                     6: Timestamp('2022-10-06 08:00:00+0000',
                                                                                  tz='UTC')}}))
        ...
        self.expected_results.append(
            pd.DataFrame({'timestamp_debut': {0: Timestamp('2022-10-03 06:31:00+0000', tz='UTC'),
                                              1: Timestamp('2022-10-03 11:30:00+0000', tz='UTC'),
                                              2: Timestamp('2022-10-04 06:30:00+0000', tz='UTC'),
                                              3: Timestamp('2022-10-04 11:30:00+0000', tz='UTC'),
                                              4: Timestamp('2022-10-05 06:30:00+0000', tz='UTC'),
    ...
    def test(self):
        for date_debut, date_fin, df_hor, expected_result in zip(self.dates_debut,
                                                                 self.dates_fin,
                                                                 self.df_horaires,
                                                                 self.expected_results):
