...
def get_data_task_assigner(access_token: str, datein_isoformat: str, dateout_isoformat: str, url: str) -> dict:
    data = {}
    sql_querys_dict = {
        ...
        'matrice_competence': {'select': ['emc_sfkutilisateur', 'emc_sfkarticle', 'emc_sniveau'],
...
def get_data_planning_optimizer(access_token: str,
