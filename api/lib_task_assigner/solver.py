...
from api.lib_task_assigner.solution_statistics.statistics import (
    make_stat_cmp,
    make_stat_prj,
    make_stat_tsk,
    make_stat_utl,
...
from api.lib_task_assigner.tools.id_remapping import (
    make_list_ids,
...
from api.lib_task_assigner.tools.matrix_maker import (
    make_mat_cmp,
    make_mat_prj,
    make_mat_spe,
)
from api.lib_task_assigner.tools.problem_formulation import (
    make_matrix_a_and_b,
...
def solve_linear_programation_problem(
    ...
    linprog_solver = linprog(
        -cost_func, A_eq=matrix_a, b_eq=b, method="highs-ds", options={"maxiter": 10000}
    )
