    ...
    def setUp(self):
        ...
        self.imperatifs = pd.DataFrame(
            {'evt_spkevenement': {0: 1040,
             ...
             'lgl_sfkligneparent': {0: 2283,
                                    ...
                                    5: 2283,
                                    6: 2283},
             'evt_xdate_debut': {0: pd.Timestamp('2022-09-05 08:30:00+0000', tz='UTC'),
             ...
             'evt_xdate_fin': {0: pd.Timestamp('2022-09-05 09:30:00+0000', tz='UTC'),
        ...
        self.expected_result = pd.DataFrame(
            {'start': {0: pd.Timestamp('2022-09-05 09:30:00+0000', tz='UTC'),
             ...
             'end': {0: pd.Timestamp('2022-09-05 15:00:00+0000', tz='UTC'),
...
class TestComputeAvailabilities(unittest.TestCase):
    def setUp(self):
        ...
        self.expected_result = pd.DataFrame({'timestamp_debut': {0:pd.Timestamp('2022-09-05 09:30:00+0000', tz='UTC'),
                                         ...
                                         'timestamp_fin': {0:pd.Timestamp('2022-09-05 10:30:00+0000', tz='UTC'),
                                          1:pd.Timestamp('2022-09-05 15:00:00+0000', tz='UTC'),
                                          2:pd.Timestamp('2022-09-06 09:00:00+0000', tz='UTC'),
