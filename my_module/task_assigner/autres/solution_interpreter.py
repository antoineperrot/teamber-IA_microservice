...
def make_statistics(capacite_utilisateurs: np.array, solution: np.array, arcs: list):
    output = {
        "charge_utilisateurs": compute_charge_utilisateur(
            capacite_utilisateurs, solution, arcs
        ),
...
def compute_charge_utilisateur(
    capacite_utilisateurs: np.array, solution: np.array, arcs: list
):
    ...
    out_dict = {
        ...
        "busy_time_percent": np.round(
            charges_utilisateurs / capacite_utilisateurs * 100
        ),
    }
