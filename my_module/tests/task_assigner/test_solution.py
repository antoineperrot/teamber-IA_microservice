...
class TestSolution(unittest.TestCase):
    ...
    def test_validite_mathematique(self):
        ...
        self.assertTrue(all(solution_brute["duree_assignee"] >= 0), msg="Un nombre d'heure négatif a été assigné.")
        self.assertTrue(all(solution_brute["duree_assignee"] <= solution_brute["tsk_lgt"]),
