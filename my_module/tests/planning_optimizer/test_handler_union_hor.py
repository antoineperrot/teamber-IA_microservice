...
class TestHandlerUnionHor(unittest.TestCase):
    def setUp(self):
        ...
        self.list_test_union.append(pd.DataFrame({"eeh_sfkperiode": [1, 1],
                                                  "eeh_xheuredebut": ["06:30", "06:45"],
                                                  "eeh_xheurefin": ["10:00", "11:00"]}))

        self.list_expected_result.append(pd.DataFrame({"eeh_sfkperiode": [1],
        ...
        self.list_test_union.append(pd.DataFrame({"eeh_sfkperiode": [1, 2],
                                                  "eeh_xheuredebut": ["06:30", "06:45"],
                                                  "eeh_xheurefin": ["10:00", "11:00"]}))
    ...
    def test_handler_union_hor(self):
        for test_union, expected_result in zip(self.list_test_union,
                                               self.list_expected_result):
