...
from my_module.planning_optimizer.planning_optimizer.tools.data_handlers import make_horaire_clean
...
class TestMakeCleanHor(unittest.TestCase):
    ...
    def setUp(self):
        self.input_value = pickle.load(open("my_module/tests/planning_optimizer/test_data/input_handler_hor.pkl", 'rb'))
        self.expected_result = pickle.load(
            open("my_module/tests/planning_optimizer/test_data/expected_result_make_clean_hor.pkl", 'rb'))
    ...
    def test_make_clean_hor(self):
        ...
        self.assertSetEqual(set_keys_output_func, set_keys_expected_result,
